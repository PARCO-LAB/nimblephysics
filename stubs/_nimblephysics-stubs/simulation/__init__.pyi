...
import nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.constraint
...
class World():
    ...
    def addSimpleFrame(self, frame: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.SimpleFrame) -> str: ...
    def addSkeleton(self, skeleton: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> str: ...
    def bake(self) -> None: ...
    @typing.overload
    def checkCollision(self) -> bool: ...
    @typing.overload
    def checkCollision(self, option: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.collision.CollisionOption) -> bool: ...
    @typing.overload
    def checkCollision(self, option: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.collision.CollisionOption, result: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.collision.CollisionResult) -> bool: ...
    ...
    def getBodyNodeByIndex(self, arg0: int) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode: ...
    def getCachedLCPSolution(self) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def getConstraintSolver(self) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.constraint.ConstraintSolver: ...
    ...
    def getLastCollisionResult(self) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.collision.CollisionResult: ...
    ...
    @typing.overload
    def getSimpleFrame(self, index: int) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.SimpleFrame: ...
    @typing.overload
    def getSimpleFrame(self, name: str) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.SimpleFrame: ...
    @typing.overload
    def getSkeleton(self, index: int) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton: ...
    @typing.overload
    def getSkeleton(self, name: str) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton: ...
    ...
    def getWrtMass(self) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.neural.WithRespectToMass: ...
    def hasSkeleton(self, skeleton: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> bool: ...
    ...
    def loadSkeleton(self, path: str, basePosition: numpy.ndarray[numpy.float64, _Shape[3, 1]] = array([0., 0., 0.]), baseEulerAnglesXYZ: numpy.ndarray[numpy.float64, _Shape[3, 1]] = array([0., 0., 0.])) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton: ...
    def positionsToJson(self) -> str: ...
    def removeAllSimpleFrames(self) -> typing.Set[nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.SimpleFrame]: ...
    def removeAllSkeletons(self) -> typing.Set[nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton]: ...
    def removeDofFromActionSpace(self, dofIndex: int) -> None: ...
    def removeSimpleFrame(self, frame: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.SimpleFrame) -> None: ...
    def removeSkeleton(self, skeleton: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> None: ...
    ...
    def toJson(self) -> str: ...
    def tuneMass(self, arg0: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, arg1: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.neural.WrtMassBodyNodeEntryType, arg2: numpy.ndarray[numpy.float64, _Shape[m, 1]], arg3: numpy.ndarray[numpy.float64, _Shape[m, 1]]) -> None: ...
    pass
