...
class ConstraintBase():
    ...
    @staticmethod
    def compressPath(skeleton: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton: ...
    def excite(self) -> None: ...
    def getDimension(self) -> int: ...
    def getInformation(self, info: ConstraintInfo) -> None: ...
    def getRootSkeleton(self) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton: ...
    @staticmethod
    def getRootSkeletonOf(skeleton: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton: ...
...
class ConstraintSolver():
    ...
    def addSkeleton(self, skeleton: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton) -> None: ...
    def addSkeletons(self, skeletons: typing.List[nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton]) -> None: ...
    ...
    def getCollisionDetector(self) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.collision.CollisionDetector: ...
    def getCollisionGroup(self) -> nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.collision.CollisionGroup: ...
    ...
    def removeSkeletons(self, skeletons: typing.List[nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton]) -> None: ...
    def replaceEnforceContactAndJointAndCustomConstraintsFn(self, arg0: typing.Callable[[], None]) -> None: ...
    def setCollisionDetector(self, collisionDetector: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.collision.CollisionDetector) -> None: ...
...
class BallJointConstraint(JointConstraint, ConstraintBase):
    @typing.overload
    def __init__(self, body: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, jointPos: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> None: ...
    @typing.overload
    def __init__(self, body1: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, body2: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, jointPos: numpy.ndarray[numpy.float64, _Shape[3, 1]]) -> None: ...
    pass
class JointCoulombFrictionConstraint(ConstraintBase):
    def __init__(self, joint: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Joint) -> None: ...
    @staticmethod
    def getConstraintForceMixing() -> float: ...
    @staticmethod
    def setConstraintForceMixing(cfm: float) -> None: ...
...
class WeldJointConstraint(JointConstraint, ConstraintBase):
    @typing.overload
    def __init__(self, body: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode) -> None: ...
    @typing.overload
    def __init__(self, body1: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, body2: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode) -> None: ...
    def setRelativeTransform(self, tf: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.math.Isometry3) -> None: ...
    pass
