...
class GUIStateMachine():
    ...
    def clear(self) -> None: ...
    def clearBodyWrench(self, body: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, prefix: str = 'wrench') -> None: ...
    ...
    def renderBodyWrench(self, body: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, wrench: numpy.ndarray[numpy.float64, _Shape[6, 1]], scaleFactor: float = 0.1, prefix: str = 'wrench', layer: str = '') -> None: ...
    def renderMovingBodyNodeVertices(self, body: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.BodyNode, scaleFactor: float = 0.1, prefix: str = 'vert-vel', layer: str = '') -> None: ...
    def renderSkeleton(self, skeleton: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.dynamics.Skeleton, prefix: str = 'world', overrideColor: numpy.ndarray[numpy.float64, _Shape[4, 1]] = array([-1., -1., -1., -1.]), layer: str = '') -> None: ...
    def renderTrajectoryLines(self, world: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.simulation.World, positions: numpy.ndarray[numpy.float64, _Shape[m, n]], prefix: str = 'trajectory', layer: str = '') -> None: ...
    def renderWorld(self, world: nimblephysics_libs.nimblephysics_libs.nimblephysics_libs.nimblephysics_libs._nimblephysics.simulation.World, prefix: str = 'world', renderForces: bool = True, renderForceMagnitudes: bool = True, layer: str = '') -> None: ...
